package edu.kit.datamanager.pit.rest;
...
public class TypingRESTResource{
  ...
  public ResponseEntity resolvePID(@PathVariable("identifier") String identifier, @RequestParam(value = "filter_by_property", defaultValue = "") String propertyIdentifier,
          @RequestParam("filter_by_type") List<String> typeIdentifiers,
