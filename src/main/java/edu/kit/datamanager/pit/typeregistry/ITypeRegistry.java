...
public interface ITypeRegistry{
  ...
  /**
   * Retrieves a property definition by its property name. Note that the name is
   * not unique, thus the method returns a List.
   *
   * @param propertyName
   ...
   *
   * @param identifier
   * @return null if there is no object with given identifier, or an instance of
   * PropertyDefinition or TypeDefinition.
   * @throws IOException
   ...
   *
   * @param pid
   * @return true if the PID is generally acceptable for the type registry, but
