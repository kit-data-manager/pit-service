...
class TypeApiTest {
    ...
    // PID of checksum type in dtr-test. Currently (Dec 2024), the schema that type-api generates in malformed.
    ...
    void querySchemaOfComplexType() {
        Set<Schema> s = dtr.querySchemas(PID_COMPLEX_TYPE_CHECKSUM_DTRTEST);
